...
const ProfilePage = () => {
  ...
  const currentPlan = selectedPlanId
    ...
    : activePlan;
  return (
    <section className="relative z-10 pt-3 pb-32 flex-grow container mx-auto px-4">
          ...
          {currentPlan && (
            <div className="relative backdrop-blur-sm border border-border rounded-lg p-6">
              ...
              <Tabs defaultValue="workout" className="w-full">
                {/* tabs created for changing between workout and diet plan */}
                ...
                <TabsContent value="workout">
                  <div className="space-y-4">
                    ...
                    {/* this component is for workout plan details and it is collapsible */}
